...
add_filter( 'wpseo_schema_graph', 'nvx_extend_yoast_schema_graph' );
...
add_filter( 'wpseo_schema_graph', 'nvx_schema_gate_faq_emission' );
...
add_filter( 'wpseo_schema_graph', 'nvx_schema_deduplicate_ids' );
