<?php
/**
 * Signature Phase page rendering: list markup, section markup, page markup,
 * hub catalog, hub rendering, redirect, filters, SEO, schema, and hooks.
 *
 * Catalog data is in nvx-signature-catalog.php (loaded first).
 *
 * @package NUVANX
 */
